...
public class AbstractGatewayValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        try {
            ...
            String logMessage = (requestBody.getGatewayUuid() != null && requestBody.getGatewayUuid() != "") ?
        ...
        try {
            ...
            String logMessage = (requestBody.getGatewayIpv4() != null && requestBody.getGatewayIpv4() != "") ?
        ...
        try {
            ...
            String logMessage = (requestBody.getGatewayName() != null && requestBody.getGatewayName() != "") ?
